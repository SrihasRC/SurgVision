"""
YOLOv11 Segmentation - Video Inference for Server/Headless Execution
Optimized for GPU server execution without display output
"""
...
VIDEO_PATH = "iv2.mp4"  # Input video path
    ...
    while cap.isOpened():
        ...
        if frame_count % 30 == 0:
            ...
            print(f"Progress: {frame_count}/{total_frames} frames ({progress:.1f}%) | "
                  f"Avg FPS: {fps_avg:.1f} | ETA: {eta:.1f}s")
